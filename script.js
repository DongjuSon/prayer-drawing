...
const prayerCards = [
    // 인도 (India) - 3 cards
    {
        ...
        cardImage: "images/cards/IMG_0094.png"
    },
    {
        country: "인도",
        topic: "Goodness of God",
        ...
        cardImage: "images/cards/IMG_0095.png"
    },
    {
        country: "인도",
        topic: "Goodness of God",
        ...
        cardImage: "images/cards/IMG_0096.png"
    },
    // 인도네시아 (Indonesia) - 3 cards
    {
        ...
        cardImage: "images/cards/IMG_0097.png"
    },
    {
        country: "인도네시아",
        topic: "END, AND",
        ...
        cardImage: "images/cards/IMG_0098.png"
    },
    {
        country: "인도네시아",
        topic: "END, AND",
        ...
        cardImage: "images/cards/IMG_0099.png"
    },
    // 일본 (Japan) - 3 cards
    {
        country: "일본",
        ...
        cardImage: "images/cards/IMG_0103.png"
    },
    {
        country: "일본",
        topic: "Seeds of the Kingdom",
        ...
        cardImage: "images/cards/IMG_0100.png"
    },
    {
        country: "일본",
        topic: "Seeds of the Kingdom",
        ...
        cardImage: "images/cards/IMG_0101.png"
    },
    // 우간다 (Uganda) - 3 cards
    {
        country: "우간다",
        ...
        cardImage: "images/cards/IMG_0091.png"
    },
    {
        country: "우간다",
        topic: "Clean Vessels",
        ...
        cardImage: "images/cards/IMG_0092.png"
    },
    {
        country: "우간다",
        topic: "Clean Vessels",
        ...
        cardImage: "images/cards/IMG_0093.png"
    },
    // 베트남 (Vietnam) - 3 cards
    {
        country: "베트남",
        ...
        cardImage: "images/cards/IMG_0085.png"
    },
    {
        country: "베트남",
        topic: "Deep to Deep",
        ...
        cardImage: "images/cards/IMG_0086.png"
    },
    {
        country: "베트남",
        topic: "Deep to Deep",
        ...
        cardImage: "images/cards/IMG_0087.png"
    },
    // 네팔 (Nepal) - 3 cards
    {
        country: "네팔",
        ...
        cardImage: "images/cards/IMG_0080.png"
    },
    {
        country: "네팔",
        topic: "Press On",
        ...
        cardImage: "images/cards/IMG_0081.png"
    },
    {
        country: "네팔",
        topic: "Press On",
        ...
        cardImage: "images/cards/IMG_0082.png"
    },
    // 상주 (Sangju) - 3 cards
    {
        country: "상주",
        ...
        cardImage: "images/cards/IMG_0088.png"
    },
    {
        country: "상주",
        topic: "Faith from Hearing",
        ...
        cardImage: "images/cards/IMG_0089.png"
    },
    {
        country: "상주",
        topic: "Faith from Hearing",
        ...
        cardImage: "images/cards/IMG_0090.png"
    },
    // 당진 (Dangjin) - 3 cards
    {
        country: "당진",
        ...
        cardImage: "images/cards/IMG_0083.png"
    },
    {
        country: "당진",
        topic: "Remember Me!",
        ...
        cardImage: "images/cards/IMG_0102.png"
    },
    {
        country: "당진",
        topic: "Remember Me!",
        ...
        cardImage: "images/cards/IMG_0084.png"
    }
];
...
function displayResult() {
    ...
    // Get the result screen and card container
    ...
    // Create and display the prayer card image
    const cardImg = document.createElement('img');
    cardImg.src = currentCard.cardImage;
    cardImg.alt = `${currentCard.country} - ${currentCard.topic}`;
    cardImg.className = 'prayer-card-image';
    ...
    cardFooter.innerHTML = `
        <button id="download-btn" class="download-button" aria-label="이미지 저장하기">
            <span aria-hidden="true">⬇</span> 이미지 저장하기
        </button>
    `;
    resultCard.appendChild(cardFooter);

    // Reattach download event listener
    const downloadBtn = document.getElementById('download-btn');
    if (downloadBtn) {
        downloadBtn.addEventListener('click', downloadImage);
    }
...
async function downloadImage() {
    ...
    try {
        ...
        const response = await fetch(currentCard.cardImage);
        const blob = await response.blob();

        // Create download link
        const url = URL.createObjectURL(blob);
        const link = document.createElement('a');
        const countryName = currentCard.country.replace(/\s+/g, '-');
